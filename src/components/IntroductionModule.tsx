  ...
  const features = [
    {
      ...
      content: [
        <p "我们依托前沿的人工智能技术，打造出新一代学术质量检测引擎。它不仅能处理文本，更能深度理解学术内涵。",
        </p>
        "- 底层架构： 基于强大的自然语言处理（NLP）与深度学习架构，具备像人类专家一样的语义解析与逻辑推理能力。- 多维分析： 对文本进行语法、结构、逻辑、论证效力及学术规范性的全方位、多模态扫描，精准定位深层问题。- 智能进化： 系统依托持续学习机制，在不断处理海量优质学术文本中自我迭代，确保检测能力始终位于行业前沿。"
      ]
    },
    {
