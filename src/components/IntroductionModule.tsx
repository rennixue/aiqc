  ...
  const features = [
    {
      ...
      content: [
        "我们依托前沿的人工智能技术，打造出新一代学术质量检测引擎。它不仅能处理文本，更能深度理解学术内涵。- 底层架构： 基于强大的自然语言处理（NLP）与深度学习架构，具备像人类专家一样的语义解析与逻辑推理能力。- 多维分析： 对文本进行语法、结构、逻辑、论证效力及学术规范性的全方位、多模态扫描，精准定位深层问题。- 智能进化： 系统依托持续学习机制，在不断处理海量优质学术文本中自我迭代，确保检测能力始终位于行业前沿。"
      ]
    },
    {
      ...
      content: [
        "判断精准，因为我们见识广。我们的系统经过海量优质学术数据的训练。- 覆盖全面： 内含百万篇各学科论文、作业和课件数据，支撑起庞大的知识点地图。- 对标标杆： 无论您是什么专业，您的作品都在与高质量的学术基准进行比对。- 洞察趋势： 了解不同院校的常见要求与误区，让您的作业更符合期待。"
      ]
    },
    {
      ...
      content: [
        "您的心血之作，我们用心守护。我们郑重承诺：- 绝对专用： 您的文件仅用于本次质量分析，我们绝不会将其用于任何其他用途，更不会泄露给任何第三方。- 匿名处理： 分析过程中，您的个人信息会被剥离，仅分析内容本身。- 及时销毁： 分析完成后，您的原始文件将在24小时内自动删除，不留存任何底稿，请放心使用。"
      ]
    }
  ];
